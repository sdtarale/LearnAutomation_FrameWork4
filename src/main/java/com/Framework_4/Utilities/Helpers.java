package com.Framework_4.Utilities;
...
public class Helpers {
	...
	//Scroll and Highlight WebELement 	
	...
	//Broken Images identification  Utilities
		...
		//click in webelemnt using By locator and Java script executer
		...
		//click in webelemnt using By locator and Java script executer with wait time
		...
		//Find and click a weblement from multiple element list utilities
	...
	//Screenshot capture utilities
		...
		public static String captureScreeshotBase64(WebDriver driver)
		{
			TakesScreenshot ts=(TakesScreenshot) driver;
